...
//    private ApplicationContext applicationContext;
    ...
    public List<SysUser> selectUserByIds(Long []ids){
        List<SysUser> list = userMapper.selectUserByIds(ids);
        return list;
    }
    /**
     * 根据条件分页查询已分配用户角色列表
