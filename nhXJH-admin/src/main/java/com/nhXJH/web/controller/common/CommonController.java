package com.nhXJH.web.controller.common;
...
import com.nhXJH.framework.config.ServerConfig;
...
public class CommonController {
    ...
    public void fileDownload(String fileName, Boolean delete, HttpServletResponse response, HttpServletRequest request) {
        try {
            ...
            String filePath = LibraryMSConfig.getDownloadPath() + fileName;
    ...
    public AjaxResult uploadFile(MultipartFile file) {
        try {
            // 上传文件路径
            String filePath = LibraryMSConfig.getUploadPath();
            // 上传并返回新文件名称
    ...
    public void resourceDownload(String resource, HttpServletRequest request, HttpServletResponse response) {
        try{
            ...
            // 本地资源路径
            String localPath = LibraryMSConfig.getProfile();
            // 数据库资源地址
